...
/// </summary>
public class GrabComponent : MonoBehaviour, IInputHandler, ISourceStateHandler
    {
        [SerializeField]
    ...
    private Vector3 deltaPosition;
        ...
        print(deltaPosition);
        GetComponent<Rigidbody>().velocity = deltaPosition;//new Vector3(-deltaPosition.z,deltaPosition.y,deltaPosition.x) * 1;
        ...
        private void OnOneHandMoveUpdated()
        {
            ...
            hostTransform.position = targetPosition;
        deltaPosition = (targetPosition - deltaPosition); 
    }
